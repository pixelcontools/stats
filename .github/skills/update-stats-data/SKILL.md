...
Only use this if `scripts/users.json` already exists locally (generated by a previous `--save-raw` run). Do NOT pass `userdata.json` — that is already compact format and will produce 0 members.
